...
from timeout_decorator import timeout  # ⏱️ Enforce a time limit per test
from source.cpp.solution import cppSolution  # 🧩 Import your C++ Cython wrapper
...
class test_cpp_Solution(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(filePath, mode="r", encoding="utf-8") as read_file: 
            ...
            self.__solution = cppSolution()           # ⚡ Initialize C++ solution
    ...
    def test(self):
        ...
        for testcase in self.__testcases:
            ...
            with self.subTest(testName):
                actualOutput: int = self.__solution.cpp_trap(height = height)
